...
List<City> allAddedCities = [
  ...
  new City(name: "Buenos Aires", country: Country.BR, active: false, listIdx: 2),
  ...
  new City(name: "San Francisco", country: Country.US, active: false, listIdx: 9),
  new City(name: "San Francisco", country: Country.US, active: false, listIdx: 10),
